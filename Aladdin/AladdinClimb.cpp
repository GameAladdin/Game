...
void AladdinClimb::Activities(DIRECTION direction)
{
...
void AladdinClimb::Update(DIRECTION direction)
{
	mCurrentLocation.y -= (direction == UP) ? this->mSpeed : 0;
	mCurrentLocation.y += (direction == DOWN) ? this->mSpeed : 0;
}
