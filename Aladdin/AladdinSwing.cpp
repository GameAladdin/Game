...
void AladdinSwing::Activities(DIRECTION direction)
{
	if (direction == RIGHT)
...
void AladdinSwing::Update(DIRECTION direction)
{
	mCurrentLocation.x += (direction == RIGHT) ? this->mSpeed : 0;
	mCurrentLocation.x += (direction == LEFT) ? (-this->mSpeed) : 0;
}
