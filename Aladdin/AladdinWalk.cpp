...
void AladdinWalk::Activities(DIRECTION direction)
{
...
void AladdinWalk::Update(DIRECTION direction)
{
	AladdinAction::mCurrentLocation.x += (direction == RIGHT) ? this->mSpeed : 0;
	AladdinAction::mCurrentLocation.x += (direction == LEFT) ? (-this->mSpeed) : 0;
}
