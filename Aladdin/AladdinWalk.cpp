...
void AladdinWalk::Activities(Engine::DIRECTION direction)
{
	//Engine::SetFrameRate(35);
...
void AladdinWalk::Update(Engine::DIRECTION direction)
{
	AladdinAction::mCurrentLocation.x += (direction == Engine::RIGHT) ? this->mSpeed : 0;
	AladdinAction::mCurrentLocation.x += (direction == Engine::LEFT) ? (-this->mSpeed) : 0;
}
